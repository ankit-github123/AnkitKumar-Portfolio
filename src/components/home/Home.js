  ...
  return (
    <div id="home" className="home">
      ...
      <div className="home_mid">
        ...
        <ReactRoate items={['A Creative Freelancer & Full Stack Developer']} />
      ...
      <div className="home_end_container">
        ...
        {scrolly>=10 ?<Link to="home" spy={true} smooth={true}><div className="move_to_top" onMouseEnter={()=>setcolor(true)} onMouseLeave={()=>{setcolor(false)}}>
        <span className="arrow_top" style={color?{color:"#e24840"}:null}>
