...
const Services = () => {
      ...
      return (
            <div id="services" className="services_main common_pad_left common_pad_right">
                  <ScrollAnimation
                        animateIn="fadeIn"
                        duration={2}
                        animateOnce={true}
                  ...
                  >
                        <div className="services_title">
                              <h6 className={"color"} > What I do</h6> <h1> My Services </h1> <div className="border_botton_red" > </div>
                        </div>
                  </ScrollAnimation>
